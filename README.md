...
```bash
az staticwebapp create -n StarterNextJSTailwindCSS -g StarterNextJS -s https://github.com/<YOUR_GITHUB_USERNAME>/react-conntect-four-game -l WestUs2 -b main --login-with-github
```
...
```bash 
https://github.com/<YOUR_GITHUB_USERNAME>/react-conntect-four-game/actions
```
...
``` bash
sed -i "s/react-conntect-four-game/<your project name>/" package.json package-lock.json README.md
chmod u+x setup.sh
```
